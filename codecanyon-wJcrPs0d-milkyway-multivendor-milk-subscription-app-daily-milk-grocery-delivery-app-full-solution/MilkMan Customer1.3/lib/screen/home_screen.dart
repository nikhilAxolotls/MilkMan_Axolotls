                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  Get.to(ProfileScreen(leadingIcon: true));
                                },
                                child: Container(
                                  height: 40,
                                  width: 40,
                          ...
                          InkWell(
                            onTap: () async {
                              Get.to(HomeSearchScreen(statusWiseSearch: true));
                              // Get.to(HomeSearchScreen(), arguments: {
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: CarouselSlider(
                                        ...
                                        items: homePageController.bannerList.map(
                                              (item) => Container(
                                                width: Get.size.width,
                                    ...
                                    SizedBox(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...List.generate(homePageController.homeInfo!.homeData.banlist.length, (index) {
                                            return Indicator(
                                    ...
                                    SizedBox(
                                      height: 260,
                                      width: Get.size.width,
                                      child: homePageController.homeInfo!.homeData.spotlightStore.isNotEmpty
                                          ? ListView.builder(
                                              itemCount: homePageController.homeInfo?.homeData.spotlightStore.length,
                                              scrollDirection: Axis.horizontal,
                                              physics: BouncingScrollPhysics(),
                                              itemBuilder: (context, index) {
                                                return InkWell(
                                                  onTap: () async {
                                                    catDetailsController.strId = homePageController.homeInfo?.homeData.spotlightStore[index].storeId ?? "";
                                                            ...
                                                            Container(
                                                              ...
                                                              child: ClipRRect(
                                                                ...
                                                                child: FadeInImage.assetNetwork(
                                                                  fadeInCurve: Curves.easeInCirc,
                                                                  placeholder: "assets/ezgif.com-crop.gif",
                                                                  placeholderCacheHeight: 240,
                                                                  placeholderCacheWidth: 290,
                                                                  placeholderFit:  BoxFit .fill,
                                                                  image: "${Config.imageUrl}${homePageController.homeInfo?.homeData.spotlightStore[index].storeCover ?? ""}",
                                                                  fit: BoxFit.cover,
                                                                ),
                                                              ),
                                                              decoration: BoxDecoration(
