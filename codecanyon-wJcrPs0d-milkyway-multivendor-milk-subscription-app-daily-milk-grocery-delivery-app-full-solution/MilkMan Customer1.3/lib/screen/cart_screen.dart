                                                  ...
                                                  Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Flexible(
                                                          child: Text(
                                                            productCartList[index1].productTitle!,
                                                            style: TextStyle(
                                                              fontSize: 10,
                                                              overflow: TextOverflow.ellipsis,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                catDetailsController.strId = storeList[index].storeID ?? "";
                                                await storeDataContoller.getStoreData(storeId: storeList[index].storeID);
