...
import 'package:milkmennew/model/model.dart';
import 'package:milkmennew/screen/language/language_screen.dart';
...
class ProfileScreen extends StatefulWidget {
  ...
  const ProfileScreen({super.key, required this.leadingIcon});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: WhiteColor,
        centerTitle: true,
        leading: widget.leadingIcon == false ? SizedBox() : BackButton(
          color: BlackColor,
          onPressed: () {
            Get.back();
          },
