...
class HomeSearchScreen extends StatefulWidget {
  ...
  const HomeSearchScreen({super.key, required this.statusWiseSearch});
...
class _HomeSearchScreenState extends State<HomeSearchScreen> {
  ...
  void initState() {
    ...
    super.initState();
    search.text = "";
    if (widget.statusWiseSearch == true) {
      searchController.getSearchStoreData(keyWord: "");
    } else if (widget.statusWiseSearch == false) {
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: widget.statusWiseSearch == true
                                ...
                                itemBuilder: (context, index) {
                                  return InkWell(
                                    onTap: () async {
                                      ...
                                      await storeDataContoller.getStoreData(storeId: searchController.searchInfo[index].storeId,
                                      );
                                        ...
                                        children: [
                                              ...
                                              Container(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: FadeInImage.assetNetwork(
                                                    ...
                                                    image: "${Config.imageUrl}${searchController.searchInfo[index].storeCover}",
                                                    fit: BoxFit.cover,
                                                  ),
                                                ),
                                                decoration: BoxDecoration(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          searchController.searchInfo[index].couponTitle,
                                                          maxLines: 1,
                                                          style: TextStyle(
                                                            color: WhiteColor,
                                                            fontFamily: FontFamily.gilroyBold,
                                                        ...
                                                        Text(
                                                          searchController.searchInfo[index].couponSubtitle,
                                                          maxLines: 1,
                                                          style: TextStyle(
                                                            color: WhiteColor,
                                                            fontFamily: FontFamily.gilroyMedium,
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  searchController.searchInfo[index].storeTitle,
                                                  maxLines: 1,
                                                  style: TextStyle(
                                                    color: BlackColor,
                                                    fontFamily: FontFamily.gilroyBold,
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    searchController.searchInfo[index].storeSdesc,
                                                    maxLines: 2,
                                                    style: TextStyle(
                                                      color: BlackColor,
                                                      fontFamily: FontFamily.gilroyMedium,
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      alignment:
                                                          Alignment.center,
                                                      child: Text(
                                                        searchController.searchInfo[index].storeTags[0],
                                                        maxLines: 1,
                                                        style: TextStyle(
                                                          fontFamily: FontFamily.gilroyMedium,
                      ...
                      ? searchController.searchProductInfo.isNotEmpty
                          ? Expanded(
                              child: GridView.builder(
                                shrinkWrap: true,
                                itemCount: searchController.searchProductInfo.length,
                                ...
                                itemBuilder: (context, index) {
                                  double price = (double.parse(searchController.searchProductInfo[index].productInfo[0].normalPrice) *
                                          double.parse(searchController.searchProductInfo[index].productInfo[0].productDiscount)) /
                                      100;
                                  return Stack(
                                                                        ...
                                                                        onTap: () {
                                                                          ...
                                                                          Get.toNamed(
                                                                              ...
                                                                              arguments: {
                                                                                ...
                                                                                "storeSlogan" : searchController.searchInfo[index].storeSloganTitle,
                                                                                "storeTitle" :  searchController.searchInfo[index].storeTitle,
                                                                                "storeLogo" : searchController.searchInfo[index].storeLogo,
                                                                              });
                                                                          // }
                                                                        },
                                                                        child: Container(
                                                                                                  ...
                                                                                                  child: InkWell(
                                                                                                    onTap: () {
                                                                                                      ...
                                                                                                      onAddItem(
                                                                                                        ...
                                                                                                        slogan: storeDataContoller.storeDataInfo!.storeInfo.storeSlogan,
                                                                                                      );
                                                                                                      Get.back();
                                                                                                    },
                                                                                                    child: Container(
  ...
  Future<void> onAddItem(int index, String qtys, {String? id1, price1, strTitle1, per1, isRequride1, storeId1, sPrice1, img1, productTitle1, productID, required String logo, required String slogan,}) async {
    String? id = id1;
  ...
  Future<void> onAddItem1(int index, String qtys, {String? id1, price1, strTitle1, per1, isRequride1, storeId1, sPrice1, img1, productTitle1, productId,required String logo, required String slogan}) async {
                                                  ...
                                                  if (productDetailsController.productInfo!.productData.productInfo[i].subscriptionRequired == "1") {
                                                    ...
                                                    Get.toNamed(
                                                        ...
                                                        arguments: {
                                                          ...
                                                          "storeSlogan" : searchController.searchInfo[i].storeSloganTitle,
                                                          "storeTitle" :  searchController.searchInfo[i].storeTitle,
                                                          "storeLogo" : searchController.searchInfo[i].storeLogo,
                                                        });
                                                    break;
                                                  }
                                                }
