...
import 'package:milkmennew/helpar/routes_helper.dart';
...
import 'package:milkmennew/utils/cart_item.dart';
...
class _CategoryDetailsScreenState extends State<CategoryDetailsScreen> {
                  ...
                  slivers: [
                    SliverAppBar(
                      ...
                      actions: [
                        InkWell(
                          onTap: () {
                            Get.to(HomeSearchScreen(statusWiseSearch: false));
                            // Get.toNamed(
                            //   Routes.homeSearchScreen,
                            //   arguments: {"statusWiseSearch": false,},
                            // );
                          },
                          child: Container(
                            height: 40,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  color: WhiteColor,
                                  child: ListView.builder(
                                    itemCount: storeDataContoller.storeDataInfo?.catwiseproduct.length,
                                    shrinkWrap: true,
                                    physics: NeverScrollableScrollPhysics(),
                                    padding: EdgeInsets.zero,
                                    itemBuilder: (context, index1) {
                                      return storeDataContoller.storeDataInfo!.catwiseproduct[index1].productdata.isNotEmpty
                                          ? Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                SizedBox(
                                                ...
                                                GridView.builder(
                                                  ...
                                                  itemBuilder:
                                                      (context, index) {
                                                    double price = (double.parse(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].normalPrice ?? "") *
                                                            double.parse(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].productDiscount ?? "")) /
                                                        100;
                                                    return Stack(
                                                                                      ...
                                                                                      ? InkWell(
                                                                                          onTap: () {
                                                                                            ...
                                                                                            Get.toNamed(Routes.subScribeScreen, arguments: {
                                                                                              ...
                                                                                              "storeTitle" : storeDataContoller.storeDataInfo?.storeInfo.storeTitle,
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () {
                                                                                                                        ...
                                                                                                                        onAddItem(
                                                                                                                          ...
                                                                                                                          id1: storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId ?? "",
                                                                                                                          price1: storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].normalPrice ?? "",
                                                                                                                          strTitle1: storeDataContoller.storeDataInfo?.storeInfo.storeTitle,
                                                                                                                          ...
                                                                                                                          productId: storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productId,
                                                                                                                            ...
                                                                                                                            logo: storeDataContoller.storeDataInfo!.storeInfo.storeLogo,
  ...
  Future<void> onAddItem(int index, String qtys, {String? id1, price1, strTitle1, per1, isRequride1, storeId1, sPrice1, img1, productTitle1, productId, required String slogan1,required String logo}) async {
    String? id = id1;
    ...
    newItem.price = double.parse(price1.toString()) - double.parse(finalPrice); // normal Price
    newItem.quantity = qty; // product Qty
    newItem.productPrice = double.parse(price1.toString()) - double.parse(finalPrice); // product Normal Price
    ...
    newItem.storeSlogan = slogan1;
    newItem.storeLogo = logo;
  ...
  Future<void> onAddItem1(int index, String qtys, {String? id1, price1, strTitle1, per1, isRequride1, storeId1, sPrice1, img1, productTitle1, productId, required String storeSlogan1,required String logo}) async {
    ...
    newItem.storeSlogan = storeSlogan1;
    newItem.storeLogo = logo;
  ...
  void onRemoveItem1(int index, String qtys, {String? pr1,}) {
  ...
  getSubScriptionProductTypeList() {
    print(".......+++++++++......... ${productDetailsController.productInfo!.productData.productInfo.length}");
    itemList = [];
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: PageView.builder(
                                        itemCount: productDetailsController.productInfo?.productData.img.length,
                                              ...
                                              Container(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: FadeInImage.assetNetwork(
                                                    placeholder: "assets/ezgif.com-crop.gif",
                                                    placeholderFit: BoxFit.fill,
                                                    image: "${Config.imageUrl}${productDetailsController.productInfo?.productData.img[index] ?? ""}",
                                                    fit: BoxFit.cover,
                                                  ),
                                                ),
                                                decoration: BoxDecoration(
                                          ...
                                          ? InkWell(
                                              onTap: () {
                                                for (var i = 0; i < productDetailsController.productInfo!.productData.productInfo.length; i++) {
                                                  if (productDetailsController.productInfo!.productData.productInfo[i].subscriptionRequired == "1" && productDetailsController.productInfo!.productData.productInfo[i].productOutStock == "0") {
                                                    productDetailsController.getProductDetailsApi(pId: productDetailsController.productInfo?.productData.id ?? "");
                                                    Get.toNamed(
                                                                    ...
                                                                    setState(
                                                                      ...
                                                                      onAddItem1(
                                                                        ...
                                                                        productTitle1: productDetailsController
                                                                            ...
                                                                            .title,
                                                                        productId: productDetailsController.productInfo?.productData.id,
                                                                          storeSlogan1: storeDataContoller.storeDataInfo!.storeInfo.storeSlogan,
                                                                          logo: storeDataContoller.storeDataInfo!.storeInfo.storeLogo,
                                                                      );
                                                                    });
                                                                  },
