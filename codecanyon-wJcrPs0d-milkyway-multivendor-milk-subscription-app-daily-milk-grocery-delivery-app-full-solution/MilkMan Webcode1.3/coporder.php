        ...
        <div class="page-body">
          <div class="container-fluid">        
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3>Completed Subscription Order Management</h3>
                </div>
                <div class="col-6">
             ...
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        <thead>
                                            ...
                                            <tbody>
											<?php 
											 $stmt = $medi->query("SELECT * FROM `tbl_subscribe_order` where status='Completed' and store_id=".$sdata["id"]." order by id desc limit 10");
