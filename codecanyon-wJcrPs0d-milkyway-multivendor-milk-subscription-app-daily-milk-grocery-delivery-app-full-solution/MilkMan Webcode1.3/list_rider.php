                 ...
                 <table class="display mytable" id="basic-1">
                        <thead>
                          <tr>
                                        ...
                                        <tbody>
                                           <?php 
										$city = $medi->query("select * from tbl_rider where store_id=".$sdata["id"]." order by id desc");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_rider.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button " style="float: none; margin: 5px;">
