        ...
        <div class="page-body">
          <div class="container-fluid">        
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3>Delivery  List Management</h3>
                </div>
                <div class="col-6">
             ...
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        <thead>
                                        ...
                                        <tbody>
										<?php 
										$city = $medi->query("select * from tbl_delivery where store_id=".$sdata['id']."");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_delivery.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
