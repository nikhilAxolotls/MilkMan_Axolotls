        ...
        <div class="page-body">
          <div class="container-fluid">        
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3>Extra Images List Management</h3>
                </div>
                <div class="col-6">
		  ...
		  <div class="row">
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $medi->query("select tbl_extra.*,(select tbl_product.title from tbl_product where tbl_product.id=tbl_extra.mid) as mtitle from tbl_extra where store_id=".$sdata["id"]."");
										$i=0;
