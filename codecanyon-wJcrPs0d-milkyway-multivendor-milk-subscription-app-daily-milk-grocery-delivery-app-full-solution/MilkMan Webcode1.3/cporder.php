        ...
        <div class="page-body">
          <div class="container-fluid">        
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3>Cancelled Subscription Order Management</h3>
                </div>
                <div class="col-6">
             ...
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        <thead>
                                            ...
                                            <tbody>
											<?php 
											 $stmt = $medi->query("SELECT * FROM `tbl_subscribe_order` where status='Cancelled' and store_id=".$sdata["id"]." order by id desc limit 10");
...
echo date_format($date,"d-m-Y");
											   ...
											   ?></td>
												 ...
												 <td> <button class="ppreview_d btn  btn-primary" style="    font-size: 10px;" data-id="<?php echo $row['id'];?>" data-bs-toggle="modal" data-bs-target="#myModal">Preview</button></td>
