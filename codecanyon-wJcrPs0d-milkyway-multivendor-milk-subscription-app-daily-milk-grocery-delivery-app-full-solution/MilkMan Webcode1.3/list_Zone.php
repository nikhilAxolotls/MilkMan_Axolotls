                 ...
                 <table class="display" id="basic-1">
                        <thead>
                          <tr>
                                        ...
                                        <tbody>
                                           <?php 
										$city = $medi->query("select * from zones");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										  ...
										  <a href="add_Zone.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
