		   ...
		   <div class="row">
             ...
             <div class="col-sm-12">
                <div class="card">
				 ...
				 if(isset($_GET['id']))
				 {
					 $data = $medi->query("select * from tbl_coupon where id=".$_GET['id']." and store_id=".$sdata['id']."")->fetch_assoc();
					 $count = $medi->query("select * from tbl_coupon where id=".$_GET['id']." and store_id=".$sdata['id']."")->num_rows;
					 if($count !=0)
					 {
					 ?>
