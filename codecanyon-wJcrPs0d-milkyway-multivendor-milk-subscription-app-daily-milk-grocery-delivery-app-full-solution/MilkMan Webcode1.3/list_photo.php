		  ...
		  <div class="row">
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $medi->query("select * from tbl_photo where store_id=".$sdata["id"]."");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_photo.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
