...
else 
{
	...
	if($status == 1)
	{
  $field = array('order_status'=>4,'status'=>'On Route');
	}
	else 
	{
...
$content = array(
       "en" => $name.', Your Order #'.$oid.' Has Been On Route.'
   );
$heading = array(
   "en" => "Order On Route!!"
);
...
$title_main = "Order On Route!!";
$description = $name.', Your Order #'.$oid.' Has Been On Route.';
...
$table="tbl_notification";
 ...
 $title_mains = 'Order Accepted';
$descriptions = "Rider Accepted Order #".$oid."!!";
