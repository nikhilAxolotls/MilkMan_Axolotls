        ...
        <div class="page-body">
          <div class="container-fluid">        
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3>Menu Category List Management</h3>
                </div>
                <div class="col-6">
                        ...
                        <thead>
                          <tr>
							...
							<th>Menu Category Title</th>
												...
												<th>Menu Category Status</th>
												<th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
                           <?php 
										$city = $medi->query("select * from tbl_mcat where store_id=".$sdata["id"]." order by id desc");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_mcat.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
