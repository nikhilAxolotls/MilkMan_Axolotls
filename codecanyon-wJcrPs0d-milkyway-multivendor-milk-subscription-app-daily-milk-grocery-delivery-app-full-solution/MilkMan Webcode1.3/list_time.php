        ...
        <div class="page-body">
          <div class="container-fluid">        
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3>Timeslot List Management</h3>
                </div>
                <div class="col-6">
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
                                        ...
                                        <tbody>
                                           <?php 
										$city = $medi->query("select * from tbl_time where store_id=".$sdata['id']." order by id desc");
										$i=0;
                                   ...
                                   <td><?php echo date("g:i A", strtotime($row['maxtime']));?></td>
										   ...
										   <a href="add_time.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
