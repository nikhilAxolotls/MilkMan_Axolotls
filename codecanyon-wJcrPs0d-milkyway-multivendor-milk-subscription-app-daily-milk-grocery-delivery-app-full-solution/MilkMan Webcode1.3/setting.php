...
?>
	...
	<div class="form-group mb-3 col-12">
										...
										<div class="form-group mb-3 col-6">
                                            <label><span class="text-danger">*</span> Delivery Boy Onesignal App Id</label>
                                            <input type="text" class="form-control " placeholder="Enter Delivery Boy App Onesignal App Id"  value="<?php echo $set['d_key'];?>" name="d_key" required="">
                                        </div>
										
										<div class="form-group mb-3 col-6">
                                            <label><span class="text-danger">*</span> Delivery Boy Onesignal Rest Api Key</label>
                                            <input type="text" class="form-control " placeholder="Enter Delivery Boy App Onesignal Rest Api Key"  value="<?php echo $set['d_hash'];?>" name="d_hash" required="">
                                        </div>
										
										<div class="form-group mb-3 col-6">
                                            <label><span class="text-danger">*</span> Store Onesignal App Id</label>
                                            <input type="text" class="form-control " placeholder="Enter Store Onesignal App Id"  value="<?php echo $set['s_key'];?>" name="s_key" required="">
                                        </div>
										
										<div class="form-group mb-3 col-6">
                                            <label><span class="text-danger">*</span> Store Onesignal Rest Api Key</label>
                                            <input type="text" class="form-control " placeholder="Enter Store Onesignal Rest Api Key"  value="<?php echo $set['s_hash'];?>" name="s_hash" required="">
                                        </div>
