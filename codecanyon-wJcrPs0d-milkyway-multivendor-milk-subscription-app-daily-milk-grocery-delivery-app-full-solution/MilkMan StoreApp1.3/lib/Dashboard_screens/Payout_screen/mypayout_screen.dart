...
import 'package:storeappnew/Controller_class/Withdraw_controller.dart';
...
class _MyPayoutScreenState extends State<MyPayoutScreen> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsets.only(top: Get.height * 0.03, left: 15),
                      child: Text(
                        "${currency}${dashBoardController.earningamount}",
                        textAlign: TextAlign.start,
                        style: TextStyle(
                          fontSize: 45,
                          fontFamily: FontFamily.gilroyBold,
                                              ...
                                              payOutController
                                                  ...
                                                  ? detailsRow(
                                                      detailsName:
                                                          "Payment Method".tr,
                                                      value:
                                                          "${payOutController.payoutInfo?.payoutlist[index].rType}(${payOutController.payoutInfo?.payoutlist[index].upiId})",
                                                      color: BlackColor,
                                                    )
                                                  : SizedBox(),
                                              payOutController
                          ...
                          : Padding(
                              ...
                              child: Center(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "No payout request list found".tr,
                                    style: TextStyle(
                                        color: BlackColor,
                                        fontFamily: FontFamily.gilroyBold,
                                        fontSize: 16),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "${"Minimum amount:".tr} ${dashBoardController.withdrawlimit}${currency}",
                    style: TextStyle(
                      color: BlackColor,
                      fontFamily: FontFamily.gilroyMedium,
                      fontSize: 16,
  ...
  textfield(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(15), color: transparent),
      child: TextFormField(
