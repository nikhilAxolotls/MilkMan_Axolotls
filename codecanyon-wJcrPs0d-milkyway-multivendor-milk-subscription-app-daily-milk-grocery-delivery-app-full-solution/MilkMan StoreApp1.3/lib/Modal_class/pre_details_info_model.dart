...
//
//     final prescriptiondetailsinfo = prescriptiondetailsinfoFromJson(jsonString);

import 'dart:convert';

Prescriptiondetailsinfo prescriptiondetailsinfoFromJson(String str) =>
    Prescriptiondetailsinfo.fromJson(json.decode(str));

String prescriptiondetailsinfoToJson(Prescriptiondetailsinfo data) =>
...
class Prescriptiondetailsinfo {
  ...
  factory Prescriptiondetailsinfo.fromJson(Map<String, dynamic> json) =>
      Prescriptiondetailsinfo(
